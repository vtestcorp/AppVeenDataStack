...
Scenario: Delete data service
	Given Data service "Design-String" exists
	Then Remove the data service

Scenario: Create data service
	Given Data service "Design-String" does not exist
	Then Create new data service "Design-String"
 #Under testData, picks up strings.json create the JSON

Scenario: Assign to Appcenter Group
 	Then Group "String-Group" does not exist
	Then Create new group "String-Group" 
	And assign appcenter permissions for "Design-String" dataservice
