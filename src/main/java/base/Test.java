...
public class Test {
   ...
   //  String text =JsonUtils.getJsonValue("C:\\data-Stack\\ds-dev-ui-automation-framework\\testData\\string_Text.json", "_metadata.version.release");
    // System.out.println(text);
     ...
     String data =JsonUtils.getJsonValue("C:\\data-Stack\\ds-dev-ui-automation-framework\\testData\\stringStateModel.json", "_metadata.version.document");
     System.out.println(data);
     
     String ds = JsonUtils.getJsonValue("C:\\data-Stack\\ds-dev-ui-automation-framework\\testData\\string_Text.json", "definition[0].key");
      System.out.println(ds);
       
      String Calender = JsonPath.read(path,"$.dob.rawData"); //1995-01-11T00:00:00Z
